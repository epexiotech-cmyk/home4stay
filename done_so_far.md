...
3.  **View the result**: Check `/explore` on the main site or visit `localhost:3001/[your-slug]`.
4.  **Check the data**: Look at `packages/data/property.json` to see how your entry was stored.
