...
export default async function PropertyLayout({
  ...
  // If accessed via subdomain, show property-specific layout
  return (
            ...
            <div className="mt-12 pt-10 border-t border-[var(--border)] flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
              <div className="max-w-xl">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <Logo variant="full" size="sm" link={false} className="opacity-80 grayscale hover:grayscale-0 transition-all duration-500" />
                </div>
