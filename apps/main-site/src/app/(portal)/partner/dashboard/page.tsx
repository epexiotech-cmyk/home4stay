  ...
  <GlassCard className="col-span-1 md:col-span-2 relative overflow-hidden group">
    ...
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
      <div>
        ...
        <h2 className="text-5xl font-black text-[#053344] dark:text-white tracking-tighter">₹245,200</h2>
      ...
      <div className="flex gap-4 w-full md:w-auto">
        <div className="flex-1 md:flex-none p-4 rounded-[24px] bg-white/50 dark:bg-white/5 border border-white dark:border-[#0E5A75]/10 shadow-inner">
          ...
          <p className="text-xl font-bold text-[#053344] dark:text-[#FDF6F1]">₹8,170</p>
        </div>
  ...
  <GlassCard className="flex flex-col items-center justify-center text-center">
    ...
    <div className="relative w-40 h-40 flex items-center justify-center">
      ...
      <div className="absolute flex flex-col items-center">
        <span className="text-4xl font-black text-[#053344] dark:text-white tracking-tighter">84%</span>
...
const TodayOperations = () => (
  <GlassCard className="col-span-1 md:col-span-1">
    ...
    <div className="space-y-4">
      {[
        { time: "09:00 AM", task: "Checkout - Room 402", status: "completed", icon: CheckCircle2 },
        { time: "11:30 AM", task: "New Arrival - Suite 101", status: "pending", icon: Clock },
        { time: "02:00 PM", task: "Maintenance Check", status: "upcoming", icon: AlertCircle },
      ].map((op, i) => (
  ...
  <GlassCard className="col-span-1 md:col-span-1 bg-gradient-to-br from-[#0E5A75]/5 to-transparent border-[#0E5A75]/10 dark:border-[#0983B0]/10">
    ...
    <div className="flex flex-col items-center justify-center py-6 text-center">
      <div className="w-16 h-16 rounded-full bg-[#0E5A75]/10 dark:bg-[#0983B0]/10 flex items-center justify-center mb-4 relative">
        <span className="text-2xl font-black text-[#053344] dark:text-[#0983B0]">03</span>
      ...
      <p className="text-[11px] text-[#0E5A75] dark:text-[#0983B0] font-medium mb-6 px-4">You have 3 new booking requests waiting for confirmation.</p>
