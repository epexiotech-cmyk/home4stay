...
export async function GET(request: NextRequest) {
  try {
    ...
    // 2. QUERY REAL DATABASE BOOKINGS FOR FINANCIAL SUMMARY
    ...
    // Load static tenant financials securely inside the authorized boundary
    ...
    return NextResponse.json({ error: "Failed to fetch financials data" }, { status: 500 });
  }
}
