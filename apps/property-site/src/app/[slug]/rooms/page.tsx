  ...
  return (
    <div className="min-h-screen bg-white relative">
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <RoomsList rooms={property.rooms} slug={slug} isLocked={isInGracePeriod} />
      </section>
      ...
      <section className="bg-zinc-900 py-20 px-6 text-center text-white">
        <div className="mx-auto max-w-2xl">
          ...
          {isInGracePeriod ? (
            <div className="mt-10 inline-block rounded-full bg-zinc-800 border border-zinc-700 px-10 py-4 font-bold text-zinc-500 cursor-not-allowed">
              Bookings Locked
            </div>
          ) : (
            <Link
